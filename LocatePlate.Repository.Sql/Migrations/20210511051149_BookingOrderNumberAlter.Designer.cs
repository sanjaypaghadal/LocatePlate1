...
namespace LocatePlate.Repository.Migrations
{
    ...
    [Migration("20210511051149_BookingOrderNumberAlter")]
    partial class BookingOrderNumberAlter
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LocatePlate.Model.RestaurantDomain.Booking", b =>
                {
                    ...
                    b.Property<bool>("HavingPromoCode")
                        .HasColumnType("bit");
                    ...
                    b.Property<bool>("IsValidPromoCode")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("LocatePlate.Model.RestaurantDomain.BookingOrderNumber", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("LocatePlate.Model.RestaurantDomain.CurrentLocation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("LocatePlate.Model.RestaurantDomain.MenuReservation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("LocatePlate.Model.RestaurantDomain.Ratings", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("LocatePlate.Model.RestaurantDomain.RestaurantStoreProcedure", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("RestaurantStoreProcedure");
                });

            modelBuilder.Entity("LocatePlate.Model.RestaurantDomain.Reviews", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("LocatePlate.Model.RestaurantDomain.Discount", b =>
                {
                    b.HasOne("LocatePlate.Model.RestaurantDomain.Restaurant", null)
                        .WithMany("Discounts")
                        .HasForeignKey("RestaurantId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("LocatePlate.Model.RestaurantDomain.MenuReservation", b =>
                {
                    b.HasOne("LocatePlate.Model.RestaurantDomain.Booking", null)
                        .WithMany("MenuItems")
