    ...
    public class ForgotPasswordModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    ModelState.AddModelError("Model", "Email not confirmed.");
                    return Page();
                }
                ...
                EmailHelper.Email(Input.Email, "Reset Password",
                    $"Please reset your password by <a href='{HtmlEncoder.Default.Encode(callbackUrl)}'>clicking here</a>.");

                Input.Message = "Email is sent, Please use the link in email to verify your account";
                return Page();
            }
            return Page();
        }
